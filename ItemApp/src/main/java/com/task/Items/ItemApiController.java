...
public class ItemApiController {
	...
	public ResponseEntity<Object> addItem(@RequestBody final Item item) {
		try {
			...
			ApiError apiError = new ApiError(HttpStatus.EXPECTATION_FAILED, ex.getLocalizedMessage(),
					"failed in creating new item");
    ...
    public class RestExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
           return new ResponseEntity<Object>("invalid opreation",headers,status);
        }
    }
